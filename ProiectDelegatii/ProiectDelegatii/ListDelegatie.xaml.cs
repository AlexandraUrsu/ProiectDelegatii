...
namespace ProiectDelegatii
{
    ...
    public partial class ListDelegatie : ContentPage
    {
        ...
        async void OnChooseButtonClicked(object sender, EventArgs e)
        {
            ...
            {
                DisplayAlert("Nu se pot adăuga angajați", "Delegația nu este validă. Toate câmpurile trebuie completate", "Ok");
            }
            else
            {
        ...
        protected override async void OnAppearing()
        {
            ...
            double zile = (endDatePicker.Date - startDatePicker.Date).TotalDays + 1;
            if (tara.Title == "România")
            {
                if (zile == 1)
                {
                    diurna.Text = "Diurna pentru o zi va fi de " + (zile * 50).ToString() + " lei.";
                }
                else
                {
            ...
            else
            {
                if (zile == 1)
                {
                    diurna.Text = "Diurna pentru o zi va fi de " + (zile * 35).ToString() + " euro.";
                }
                else
                {
        ...
        void UnsetOrase(object sender, EventArgs e)
        {
            loc.Title ="Localitate";
            loc.TitleColor = default;
        }

        void GetOrase(object sender, EventArgs e)
        {
